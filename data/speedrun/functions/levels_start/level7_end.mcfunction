...
scoreboard players operation @s lvl7_pb_temp = @s global_timer

execute if entity @s[tag=negative_delta_best] run scoreboard players operation @s lvl7_best < @s ticks_lvl_global
