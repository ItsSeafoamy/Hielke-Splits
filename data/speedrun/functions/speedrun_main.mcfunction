...
execute as @a[scores={level=59},tag=level57] run function speedrun:levels_start/level59_start
execute as @a[scores={level=62},tag=level59] run function speedrun:levels_start/level62_start
...
execute as @a[scores={level=84},tag=level82] run function speedrun:levels_start/level84_start
...
execute as @a[scores={level=89},tag=level87] run function speedrun:levels_start/level89_start
execute as @a[scores={level=91},tag=level89] run function speedrun:levels_start/level91_start
execute as @a[scores={level=94},tag=level91] run function speedrun:levels_start/level94_start
...
execute as @a[tag=level97,x=-168,y=8,z=-147,distance=..15] run tag @s add run_ended
execute as @a[scores={level=100},tag=level97,tag=run_ended] run function speedrun:levels_start/level97_end