...
tag @s remove run_ended

scoreboard players set @s global_timer 0

scoreboard players set @s hours_global 0
scoreboard players set @s minutes_global 0
scoreboard players set @s seconds_global 0
scoreboard players set @s ticks_global 0
...
tag @s remove level24
tag @s remove level25
tag @s remove level26
tag @s remove level27
tag @s remove level28
tag @s remove level29
tag @s remove level30
tag @s remove level31
tag @s remove level32
tag @s remove level33
tag @s remove level34
tag @s remove level35
tag @s remove level36
tag @s remove level37
tag @s remove level38
tag @s remove level39
tag @s remove level40
tag @s remove level41
tag @s remove level42
tag @s remove level43
tag @s remove level44
tag @s remove level45
tag @s remove level46
tag @s remove level47
tag @s remove level48
tag @s remove level49
tag @s remove level50
tag @s remove level51
tag @s remove level52
tag @s remove level53
tag @s remove level54
...
tag @s remove level67
tag @s remove level68
tag @s remove level69
tag @s remove level70
tag @s remove level71
tag @s remove level72
tag @s remove level73
tag @s remove level74
tag @s remove level75
tag @s remove level76
tag @s remove level77
tag @s remove level78
tag @s remove level79
