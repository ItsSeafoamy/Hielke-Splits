execute as @s[tag=!il_running, x=30,y=0,z=868,dx=19,dy=260,dz=19] run tag @s add il_running
execute as @s[tag=il_running, scores={level=13}] run tag @s add il_finished
