execute as @s[tag=!il_running, x=2, y=156, z=20, dx=1, dy=2, dz=-3] run tag @s add il_running
execute as @s[tag=il_running, x=-11, y=171, z=-1, dy=2, dz=2] run tag @s add il_finished
