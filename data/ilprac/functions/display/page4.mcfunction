...
tellraw @s ["", {"text":"[PREV]","color":"aqua","clickEvent":{"action": "run_command","value": "/trigger show_il_times_3"}},{"text":" "},{"text":"[NEXT]","color":"aqua","clickEvent":{"action": "run_command","value": "/trigger show_il_times_5"}}]