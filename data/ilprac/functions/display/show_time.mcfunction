...
tellraw @s ["", {"text":"Level ", "color":"green"}, {"score":{"name":"@s","objective":"il_display_level"},"color":"green"}, {"text":": ", "color": "gray"}, {"score":{"name":"@s","objective":"minutes_il"},"color":"yellow"},{"text":":"},{"score":{"name":"@s","objective":"seconds_il"},"color":"yellow"}, {"text":"."},{"score":{"name":"@s","objective":"il_display_time"},"color":"yellow"}]