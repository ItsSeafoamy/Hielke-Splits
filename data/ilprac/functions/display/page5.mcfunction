...
tellraw @s ["", {"text":"[PREV]","color":"aqua","clickEvent":{"action": "run_command","value": "/trigger show_il_times_4"}},{"text":" "},{"text":"[NEXT]","color":"aqua","clickEvent":{"action": "run_command","value": "/trigger show_il_times_6"}}]